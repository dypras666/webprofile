        ...
        <div class="relative h-96 md:h-[500px] lg:h-[600px]">
            @foreach($sliderPosts as $index => $post)
                <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out"
                    x-show="currentSlide === {{ $index }}" x-cloak x-transition:enter="transition-opacity duration-1000"
                    ...
                    <div class="relative z-10 h-full flex items-center">
                        <div class="container mx-auto px-4">
                            <div class="max-w-4xl">
                                ...
                                @if($post->category)
                                    <span
                                        class="inline-block bg-blue-600 text-white px-3 py-1 rounded-full text-sm font-medium mb-4">
                                        {{ $post->category->name }}
                                    </span>
                                @endif
