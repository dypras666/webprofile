                ...
                <form method="GET" action="{{ route('admin.posts.index') }}" class="flex items-center space-x-3">
                    ...
                    <div class="relative">
                        <input type="text" name="search" value="{{ request('search') }}"
                            placeholder="Search {{ strtolower($sectionTitle) }}..."
                    ...
                    @elseif($currentType === 'gallery')
                        <a href="{{ route('admin.posts.create', ['type' => 'gallery']) }}"
                            class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg flex items-center">
                            <i class="fas fa-images mr-2"></i>
                            Add New Gallery
                        </a>
                    @elseif($currentType === 'video')
                        <a href="{{ route('admin.posts.create', ['type' => 'video']) }}"
                            class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg flex items-center">
                            <i class="fas fa-video mr-2"></i>
                            Add New Video
                        </a>
                    @elseif($currentType === 'partner')
                        <a href="{{ route('admin.posts.create', ['type' => 'partner']) }}"
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            @if($post->featured_image_url)
                                                <img class="h-10 w-10 rounded object-cover mr-3" src="{{ $post->featured_image_url }}"
                                ...
                                ($post->type === 'video' ? 'bg-red-100 text-red-800' :
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap table-actions">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            @if($post->type === 'page')
                                                <a href="{{ route('admin.pages.edit', $post) }}" class="text-green-600 hover:text-green-900"
                                                    title="Edit Page">
                                            ...
                                            <button onclick="togglePublish({{ $post->id }})"
                                                class="{{ $post->is_published ? 'text-orange-600 hover:text-orange-900' : 'text-green-600 hover:text-green-900' }}"
