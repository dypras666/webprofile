            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <a href="{{ route('admin.posts.create') }}"
                        class="bg-white p-4 rounded-lg border border-gray-200 hover:border-blue-300 transition-colors">
                    ...
                    <a href="{{ route('admin.settings.index') }}"
                        class="bg-white p-4 rounded-lg border border-gray-200 hover:border-orange-300 transition-colors">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
