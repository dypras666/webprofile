                ...
                <form method="POST" action="{{ route('admin.settings.update') }}" enctype="multipart/form-data">
                    ...
                    <div id="appearance-section" class="settings-section">
                        ...
                        <div class="space-y-6">
                            ...
                            <!-- Theme Color -->
                            <div>
                                <label for="theme_color" class="block text-sm font-medium text-gray-700 mb-2">Primary Theme
                                    Color</label>
                            ...
                            <!-- Posts Per Page -->
                            <div>
                                <label for="posts_per_page" class="block text-sm font-medium text-gray-700 mb-2">Posts Per
                                    Page</label>
                    ...
                    <div id="seo-section" class="settings-section">
                        ...
                        <div class="space-y-6">
                            <!-- Meta Title -->
                            <div>
                                <label for="meta_title" class="block text-sm font-medium text-gray-700 mb-2">Default Meta
                                    Title</label>
                            ...
                            <!-- Meta Description -->
                            <div>
                                <label for="meta_description" class="block text-sm font-medium text-gray-700 mb-2">Default
                            ...
                            <!-- Meta Keywords -->
                            <div>
                                <label for="meta_keywords" class="block text-sm font-medium text-gray-700 mb-2">Default Meta
                                    Keywords</label>
                            ...
                            <!-- Google Analytics -->
                            <div>
                                <label for="google_analytics" class="block text-sm font-medium text-gray-700 mb-2">Google
                    ...
                    <div id="social-section" class="settings-section">
                        ...
                        <div class="space-y-6">
                            ...
                            <!-- Instagram -->
                            <div>
                                <label for="instagram_url" class="block text-sm font-medium text-gray-700 mb-2">Instagram
                                    URL</label>
