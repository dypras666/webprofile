...
@section('meta')
<meta name="description" content="{{ $download->description ?: 'Download ' . $download->title . ' dari LPM Institut Islam Al-Mujaddid Sabak' }}">
                        ...
                        <div class="bg-gray-50 rounded-lg p-6 mb-6">
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-sm font-medium text-gray-900 truncate ml-2" title="{{ $download->file_name }}">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-sm font-medium text-gray-900">{{ $download->formatted_file_size }}</span>
                                </div>
                                
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-gray-500">Tipe:</span>
                                    <span class="text-sm font-medium text-gray-900">{{ strtoupper(pathinfo($download->file_name, PATHINFO_EXTENSION)) }}</span>
                                </div>
