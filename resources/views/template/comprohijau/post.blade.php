    ...
    <div class="bg-gray-50 py-8 lg:py-12">
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-col lg:flex-row gap-8 lg:gap-12">
                ...
                {{-- Main Content --}}
                <article class="w-full lg:w-2/3 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            @if($nextPost)
                                <a href="{{ route('frontend.post', $nextPost->slug) }}"
                                    ...
                                    <div class="text-xs text-gray-500 mb-1 group-hover:text-primary">Selanjutnya &rarr;</div>
